...
export default HomePage;
 ...
 // {console.log("KKKKKKKK:")}
              // {console.log(this.props.track.startPoint)}
              // {console.log(this.props.track.endPoint)}
              // {console.log(this.props.track.travelMode.toUpperCase())}
