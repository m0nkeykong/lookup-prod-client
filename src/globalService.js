...
export const getTracksByCityURL = (
    fromCity,
    toCity,
    travelmode,
    Star,
    ...
    console.log(
        `${originURL}track/getTracksFilter/${fromCity}/${toCity}/${travelmode}/${Star}/${accesability}`
    )
...
export const getUpdateTrackTimeURL = (trackId, isDisable, minues) => {
    ...
    if (isDisable) disable = 'true'
    else disable = 'false'

    console.log(
        `${originURL}track/updateTrackTime/${trackId}/${disable}/${minues}`
    )
